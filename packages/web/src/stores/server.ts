...
export const useServerStore = defineStore('server', () => {
   ...
   *
   * Deployment configuration rather than a dashboard setting: recording continues while everyone
   * has the dashboard closed, and the interval is fixed for the life of the server process, so
   * `meta` reports it read-only.
   */
