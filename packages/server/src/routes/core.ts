    ...
    app.get('/meta', async (): Promise<MetaResponse> => {
      return {
        ...
        history: {
          ...
          // Position recording is deployment configuration, so this reports the interval the
          // recorder is actually running at; the SPA uses it to explain how dense a replay can be.
